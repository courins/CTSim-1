...
for i = 1 : length( delta_list )
    ...
    save(['liver_high_' num2str(delta) '.mat'], 'img_fbp_sharp', 'img_fbp_soft', 'img_pwls1', 'img_pwls2', 'img_psadmma', 'betas_psadmm' );
...
for i = 1 : length( delta_list )
    ...
    save(['liver_low_' num2str(delta) '.mat'], 'img_fbp_sharp', 'img_fbp_soft', 'img_pwls1', 'img_pwls2', 'img_psadmma', 'betas_psadmm' );
